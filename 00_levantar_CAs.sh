...
. color.sh
echo -e $WHITE_L Registrando en $BLUE CA-TLS $NORMAL...
sleep 2
...
sleep 5
echo -e $WHITE_L Registrando peer1-org1 $BLUE en CA-TLS $NORMAL...
sleep 2
fabric-ca-client register -d --id.name peer1-org1 --id.secret peer1PW --id.type peer -u https://0.0.0.0:7052
echo -e $WHITE_L Registrando peer1-org2 $BLUE en CA-TLS $NORMAL...
sleep 2
fabric-ca-client register -d --id.name peer1-org2 --id.secret peer1PW --id.type peer -u https://0.0.0.0:7052
echo -e $WHITE_L Registrando orderer1-org1 $BLUE en CA-TLS $NORMAL...
sleep 2
fabric-ca-client register -d --id.name orderer1-org1 --id.secret ordererPW --id.type orderer -u https://0.0.0.0:7052
echo -e $WHITE_L Registrando orderer1-org2 $BLUE en CA-TLS $NORMAL...
sleep 2
fabric-ca-client register -d --id.name orderer1-org2 --id.secret ordererPW --id.type orderer -u https://0.0.0.0:7052
echo -e $WHITE_L Registrando admin-org1 $BLUE en CA-TLS $NORMAL...
sleep 2
