...
public final class MensajeTransfer implements ContractInterface {
    ...
    public Mensaje enviarMensaje(final Context ctx, final String id, final String raza, final String alimentacion, final String denomOrig, final String owner, final String valor) {
        ...
        Mensaje mensaje = new Mensaje(id, raza, alimentacion, denomOrig, owner, valor, intermediarios);
    ...
    public Mensaje verMensaje(final Context ctx, final String id) {
        ...
        if (state.isEmpty() || state == null) {
            String errorMessage = String.format("Mensaje no registrado", id);
            System.out.println(errorMessage);
